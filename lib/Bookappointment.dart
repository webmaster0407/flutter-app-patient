...
class _BookAppointmentState extends State<BookAppointment> {
                              ...
                              child: CachedNetworkImage(
                                ...
                                errorWidget: (context, url, error) => ClipRRect(
                                  ...
                                  child: Image.asset("assets/images/no_image.jpg",
                                      width: width * 0.2, height: width * 0.2, fit: BoxFit.fitHeight),
                                ),
                              ),
                            ),
                          ],
                            ...
                            Container(
                              ...
                              child: Column(
                                children: [
                                  Text(
                                    '$name',
                                    style: TextStyle(fontSize: width * 0.048, color: Palette.black),
                                    overflow: TextOverflow.ellipsis,
                                  )
                                ],
                              ),
                    ...
                    children: [
                      Container(
                        child: Text(
                          ...
                          style: TextStyle(fontSize: width * 0.045, color: Colors.red[900]),
                        ),
                      ),
                      Container(
                        child: Text(
                          SharedPreferenceHelper.getString(Preferences.currency_symbol).toString() + '$appointmentFees',
                          style: TextStyle(fontSize: width * 0.04, color: Colors.grey[900]),
                        ),
                      ),
                    ],
                  ),
                              ...
                              child: Container(
                                child: Column(
                                  ...
                                  children: [
                                        ...
                                        Column(
                                          children: [
                                              ...
                                              child: Column(
                                                children: [
                                                  Text(
                                                    ...
                                                    style: TextStyle(fontSize: width * 0.04, color: Colors.red[900], fontWeight: FontWeight.bold),
                                                  )
                                                ],
                                              ),
                                            ),
                                            DropdownButtonFormField(
                                              ...
                                              value: getTranslated(context, bookAppointment_mySelf).toString(),
                                              isExpanded: true,
                                              iconSize: 30,
                                              ...
                                              validator: (dynamic value) => value == null
                                                  ? getTranslated(context, bookAppointment_appointmentFor_validator).toString()
                                                  : null,
                                    ...
                                    if(patientAddressController.text.isEmpty)...{
                                      Container(
                                        margin: EdgeInsets.only(top: width * 0.05),
                                        child: Column(
                                          children: [
            ...
            onPressed: () {
              setState(
                  ...
                  if (_currentStep == 0 && _step1.currentState!.validate()) {
                    continued();
                  } else if (_currentStep == 1 && selectTime != null && selectTime != "" && selectTime != "null") {
                    continued();
  ...
  Future<BaseModel<Bookappointments>> callApiBook() async {
    ...
    Map<String, dynamic> body = {
      "appointment_for": getTranslated(context, bookAppointment_mySelf).toString(),// selectAppointmentFor,
  ...
  void _handlePaymentSuccess(PaymentSuccessResponse response) {
    ...
    _paymentToken != "" && _paymentToken!.isNotEmpty
        ? callApiBook()
        : Fluttertoast.showToast(
        msg: getTranslated(context, bookAppointment_paymentNotComplete_toast).toString(), toastLength: Toast.LENGTH_SHORT);
  }
  ...
  payStackFunction() async {
    var amountToPaystack = "$newAppointmentFees" != "0.0" ? num.parse('$newAppointmentFees') * 100 : num.parse('$appointmentFees') * 100;
        ...
        setState(() {
          ...
          if (discountType == "AMOUNT" && isFlat == 1) {
            if (int.parse('$appointmentFees') > flatDiscount!) {
              ...
              Fluttertoast.showToast(
                msg: getTranslated(context, bookAppointment_worthMore_toast).toString() +
                    SharedPreferenceHelper.getString(Preferences.currency_symbol).toString() +
                    '$flatDiscount.',
                toastLength: Toast.LENGTH_SHORT,
                gravity: ToastGravity.CENTER,
            ...
            Fluttertoast.showToast(
              msg: int.parse('$appointmentFees') >= prAmount || int.parse('$appointmentFees') >= minDiscount!
                  ...
                  : getTranslated(context, bookAppointment_itemWorth_toast).toString() +
                  '$prAmount' +
                  getTranslated(context, bookAppointment_orMore_toast).toString(),
              toastLength: Toast.LENGTH_SHORT,
              gravity: ToastGravity.CENTER,
            );
            newAppointmentFees = int.parse('$appointmentFees') >= prAmount || int.parse('$appointmentFees') >= minDiscount!
                ? newAppointmentFees
                : appointmentFees;
          }
        });
