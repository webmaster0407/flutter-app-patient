...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    pharmacyDetails = json['pharmacy_details'] != null
        ? new PharmacyDetails.fromJson(json['pharmacy_details'])
        : null;
...
class PharmacyDetails {
  ...
  PharmacyDetails(
      {this.id, this.name, this.image, this.address, this.fullImage});
